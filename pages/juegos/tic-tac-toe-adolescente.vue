      ...
      <transition name="slide" mode="out-in" >
        <div v-if="step === 1" key="step1">
          ...
          <p class="mt-4 text-sm sm:text-base">
            Para vencer al tabaquismo con con estrategia y marcarle tres en raya debes:
          </p>
          <ul class="text-sm sm:text-base pl-4 list-decimal">
            <li>
              Empezar respondiendo una pregunta para  tener el tiro inicial o de lo contrario lo obtendrá el tabaquismo (máquina).
            </li>
            <li>
        ...
        <div v-if="step === 3" key="step3">
          <h3 class="text-center text-2xl sm:text-4xl text-white font-semibold mb-5 mt-8">
            Márcale tres en raya al tabaquismo
          </h3>
  ...
  methods: {
    ...
    showFinalModal(result) {
      ...
      if (result === 'TIE') {
        ...
        this.modalResult.content ="¡Felicitaciones! Haz vencido al tabaquismo.";
      } else {
        this.modalResult.title = 'Perdiste';
        this.modalResult.content ="El tabaquismo te ha vencido, pero no te preocupes, intenta vencerlo nuevamente.";
      }
